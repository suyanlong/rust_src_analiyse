...
//! Basic functions for dealing with memory.//这句的意思，基础函数。
//!
//! This module contains functions for querying the size and alignment of
//! types, initializing and manipulating memory.//主要时对内存的操作。
...
/// use std::mem;
///
/// assert_eq!(4, mem::size_of::<i32>());//看到这里，明白使用这个函数的方式了。
/// ```
#[inline]
#[stable(feature = "rust1", since = "1.0.0")]
